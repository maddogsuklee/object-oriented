...
public interface Polynom_able extends cont_function{
	...
	//public Polynom_able Init(String s);
	
	//public static Polynom_able Init(){
	//	Polynom_able m=new Polynom();
	//	return m;
	//}
	/**
	...
	public int getmonindex(Monom m); // see in class 'polynom'
	
	public int getpowindex(Monom m);// see in class 'polynom'
}
